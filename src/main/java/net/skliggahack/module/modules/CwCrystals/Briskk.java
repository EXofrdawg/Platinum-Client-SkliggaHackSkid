...
public class Briskk extends Module implements PlayerTickListener, ItemUseListener
{
    ...
    public Briskk()
    {
        super("BriskkCrystal", "crystal like marlow", false, Category.CwCrystals);
    }

    private int crystalBreakClock = 0;

    public Briskk(String name, String description, boolean enabled, Category category) {
