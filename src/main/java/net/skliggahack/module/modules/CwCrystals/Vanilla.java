...
public class Vanilla extends Module implements PlayerTickListener, ItemUseListener
{
    ...
    public Vanilla()
    {
        super("Vanilla+Crystal(undetectable)", "undetectable Cw but for Vanilla+", false, Category.CwCrystals);
    }

    public Vanilla(String name, String description, boolean enabled, Category category) {
