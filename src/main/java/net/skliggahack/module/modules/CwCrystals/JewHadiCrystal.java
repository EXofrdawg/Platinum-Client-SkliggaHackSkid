...
public class JewHadiCrystal extends Module implements PlayerTickListener, ItemUseListener
{
    ...
    public JewHadiCrystal()
    {
        super("JewHadiCrystal", "elias' special need >:3", false, Category.CwCrystals);
    }
