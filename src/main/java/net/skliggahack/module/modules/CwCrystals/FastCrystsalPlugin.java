package net.skliggahack.module.modules.CwCrystals;
...
public class FastCrystsalPlugin extends Module implements PlayerTickListener, ItemUseListener
{
    ...
    public FastCrystsalPlugin()
    {
        super("FastCrystalsPlugin", "crystal like marlow", false, Category.CwCrystals);
    }

    private int crystalBreakClock = 0;

    public FastCrystsalPlugin(String name, String description, boolean enabled, Category category) {
