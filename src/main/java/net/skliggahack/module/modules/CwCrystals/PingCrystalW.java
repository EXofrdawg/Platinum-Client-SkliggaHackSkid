...
public class PingCrystalW extends Module implements PlayerTickListener, ItemUseListener
{
    ...
    public PingCrystalW()
    {
        super("200PingCrystal", "crystal like marlow", false, Category.CwCrystals);
    }

    private int crystalBreakClock = 0;

    public PingCrystalW(String name, String description, boolean enabled, Category category) {
