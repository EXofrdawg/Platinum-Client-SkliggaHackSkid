...
public class PugCrystal extends Module implements PlayerTickListener, ItemUseListener
{
    ...
    public PugCrystal()
    {
        super("18PingCrystal", "crystal like marlow", false, Category.CwCrystals);
    }

    private int crystalBreakClock = 0;

    public PugCrystal(String name, String description, boolean enabled, Category category) {
