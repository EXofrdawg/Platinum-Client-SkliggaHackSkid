...
public class QbastCrystal extends Module implements PlayerTickListener, ItemUseListener
{
    ...
    public QbastCrystal()
    {
        super("qBlastCrystal", "elias' special need >:3", false, Category.CwCrystals);
    }

    public QbastCrystal(String name, String description, boolean enabled, Category category) {
