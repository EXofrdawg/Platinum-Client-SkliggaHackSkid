...
public class PingCrystal extends Module implements PlayerTickListener, ItemUseListener
{
    ...
    public PingCrystal()
    {
        super("100PingCrystal", "crystal like marlow", false, Category.CwCrystals);
    }

    private int crystalBreakClock = 0;

    public PingCrystal(String name, String description, boolean enabled, Category category) {
