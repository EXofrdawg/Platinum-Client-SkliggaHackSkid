...
public class CwCrystalReWrite extends Module implements PlayerTickListener, ItemUseListener
{
	...
	public CwCrystalReWrite()
	{
		super("CwCrystalReWrite", "crystal like marlow", false, Category.COMBAT);
	}
