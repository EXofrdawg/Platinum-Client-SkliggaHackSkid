...
public class BlanTentAutoDtap extends Module implements PlayerTickListener, ItemUseListener
{
	...
	public BlanTentAutoDtap()
	{
		super("BlatantAutoDtap", "elias' special need >:3", false, Category.COMBAT);
	}
